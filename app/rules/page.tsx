    ...
    <div className="bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="space-y-12">
          ...
          {/* Handbook Section */}
          <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-6 border-b border-gray-200 pb-2">Competition Handbook</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <Card className="h-full flex flex-col group">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Handbook</span>
                  </div>
                  <h3 className="text-lg font-bold text-gray-900 mb-3 group-hover:text-primary-blue transition-colors">
                    Competition Handbook v1
                  </h3>
                  <p className="text-gray-600 text-sm mb-4 line-clamp-3 leading-relaxed">
                    Official Formula Hellas 2026 Competition Handbook. Contains key dates, registration guidelines, event schedule, logistics, and site information.
                  </p>
                </div>
                <div className="mt-auto pt-4 border-t border-gray-100">
                  <a
                    href="/documents/Formula_Hellas_2026_Competition_Handbook_v1.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center text-primary-blue hover:text-primary-blue-dark font-semibold text-sm transition-all group/link"
                  >
