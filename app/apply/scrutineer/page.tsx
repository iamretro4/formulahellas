...
import { CONTACT_EMAIL, COMING_SOON, APPLY_SCRUTINEER_URL, APPLICATIONS_ENABLED } from '@/lib/site-config';
import { Mail } from 'lucide-react';

export default function ScrutineerApplicationPage() {
  const emailSubject = encodeURIComponent('Formula Hellas 2026 Scrutineer Application');
  const emailBody = encodeURIComponent(
    `Dear Formula Hellas Organizers,\n\nI would like to apply to become a Scrutineer for Formula Hellas 2026. Below are my details:\n\n1. Full Name: \n2. Phone Number: \n3. Preferred Area (e.g. Mechanical Scrutineering, Electrical/EV Scrutineering):\n4. Relevant Experience/Engineering Background: \n\nThank you!`
  );
